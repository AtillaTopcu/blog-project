package com.atillatpc.token_mail.api;

import com.atillatpc.business.services.interfaces.IEmailServices;
import com.atillatpc.controller.interfaces.IEmailApi;
...
public class EmailApiImpl implements IEmailApi<EmailDto> {
    ...
    // http://localhost:5555/email/api/v1.0.0/basic/email
    ...
    // http://localhost:5555/email/api/v1.0.0/attachment/email
