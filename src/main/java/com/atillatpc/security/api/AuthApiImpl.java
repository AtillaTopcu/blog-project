package com.atillatpc.security.api;

import com.atillatpc.error.ApiResult;
import com.atillatpc.security.UserPrincipal;
import com.atillatpc.security.jwt.JwtTokenProvider;
...
public class AuthApiImpl {
    ...
    // LOGIN
    // POST: http://localhost:5555/auth/api/v1/login
    @PostMapping("/login")
    ...
    // ME (oturum sahibi)
    // GET: http://localhost:5555/auth/api/v1/me
    ...
    // POST: http://localhost:5555/auth/api/v1/refresh
    @PreAuthorize("isAuthenticated()")
    @PostMapping("/refresh")
    ...
    // GET: http://localhost:5555/auth/api/v1/admin/ping
    ...
    // GET: http://localhost:5555/auth/api/v1/user/ping
