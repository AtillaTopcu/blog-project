...
backend_frontend_deployment() {
    ...
    if [[ $mavenCompileInstallResult == "e" || $mavenCompileInstallResult == "E" ]]; then
        ...
        # curl -H "Accept: application/json" http://container_blog_springboot_react:5555/blog/category/api/v1/list
        ...
        #curl http://container_blog_springboot:5555/blog/category/api/v1/list
